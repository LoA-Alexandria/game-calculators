...
function take the guild it is setting. They only add tables, columns, functions
and policies, so applying them changes nothing until a guild fills a board in or
offers an alliance.
