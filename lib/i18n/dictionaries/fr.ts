...
const fr: Dictionary = {
  ...
  guideEntries: {
    ...
    artwork: {
      ...
      summary: "Quels tableaux vont avec quels héros, ce que chaque set fait, et dans quel ordre y investir.",
      intro: "Les tableaux se posent sur les héros. Un set complet donne le skill de set, puis les étoiles et les niveaux. Filtrez le catalogue par héros pour voir chaque toile qui le nomme.",
