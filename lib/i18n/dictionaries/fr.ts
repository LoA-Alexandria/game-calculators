...
const fr: Dictionary = {
  ...
  guideEntries: {
    ...
    artworkLayouts: {
      ...
      intro: "Les tableaux se posent sur les héros. Débloquez ce que vous pouvez, complétez les sets, puis étoilez et montez. Qui est sur quelle toile est dans le catalogue Artwork.",
      credit: "Guide d’Autumn (Ice, S12), partagé sur Discord",
      creditDate: "4 septembre 2026",
      status: "En cours",
      ...
      catalogueLink: "Catalogue des tableaux",
      sections: [
        {
          heading: "Où investir",
          body: [
