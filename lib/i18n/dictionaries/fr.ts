...
const fr: Dictionary = {
  ...
  guideEntries: {
    ...
    artworkLayouts: {
      ...
      restNote: "Le reste a à peu près la même utilité.",
      pursuitNote: "Remplacez Nature in Bloom par Self-Portrait.",
      dotNote: "Remplacez Nature in Bloom par Urban Proletariat — Autumn note que le DoT a tiré la courte paille, et que ce set est à jeter.",
      hybridNote: "Suivez l’ordre de votre type de dégâts principal, et ajoutez l’autre (Self-Portrait ou Urban Proletariat) entre Ukiya-e Masterpieces et Modernist New Voice.",
