...
const de: Dictionary = {
  ...
  guideEntries: {
    ...
    artworkLayouts: {
      ...
      intro: "Gemälde sitzen auf Helden. Schalte frei, was du kannst, sammle volle Sets, dann sterne und stufe. Wer auf welcher Leinwand sitzt, steht im Artwork-Katalog.",
      credit: "Guide von Autumn (Ice, S12), geteilt auf Discord",
      creditDate: "4. September 2026",
      status: "In Arbeit",
