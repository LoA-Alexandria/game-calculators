...
const de: Dictionary = {
  ...
  guideEntries: {
    heroes: {
      ...
      skillsPending: "Noch kein Skill-Text.",
    ...
    heroTierList: {
      ...
      reasonShow: "Warum?",
      reasonHide: "Ausblenden",
      reasonLabel: "Warum {hero} hier steht",
  ...
  heroEditor: {
    ...
    removeSkill: "Skill {number} entfernen",
    moveUp: "Nach oben",
    moveDown: "Nach unten",
    ...
    problemEmptySkill: "{hero}: Skill {number} braucht Name und Text.",
