...
const de: Dictionary = {
  ...
  guideEntries: {
    ...
    artworkLayouts: {
      ...
      restNote: "Der Rest ist in der Utility etwa gleich.",
      pursuitNote: "Tausche Nature in Bloom gegen Self-Portrait.",
      dotNote: "Tausche Nature in Bloom gegen Urban Proletariat — Autumn notiert, dass DoT den Kürzeren zog und dieses Set Müll ist.",
      hybridNote: "Folge der Reihenfolge deines Hauptschadenstyps und setze den anderen (Self-Portrait oder Urban Proletariat) zwischen Ukiya-e Masterpieces und Modernist New Voice.",
