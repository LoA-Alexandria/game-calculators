...
const en = {
  ...
  premium: {
    badge: "Premium",
    title: "Premium",
    lede: "Unlock selected calculators and simulations, and request one guild listing each month you stay Premium.",
    ...
    benefitMonthly: "Access runs for {days} days from each approved payment.",
    payTitle: "Pay with PayPal",
    payLede: "Checkout opens on PayPal. After you pay, sign in here and claim with your transaction id so an admin can unlock Premium.",
    stepPay: "Pay on PayPal with the button below.",
    ...
    claimLede: "Enter the transaction id from your PayPal receipt. An admin reviews claims and extends Premium by 30 days.",
    ...
    lockedLede: "This calculator or simulation is included with Premium. Buy Premium, then claim your payment to unlock it.",
    unlockHint: "Premium — tap to unlock",
    activeTitle: "You have Premium",
    activeUntil: "Active until {when}",
    renewHint: "To renew, pay again on PayPal and submit another claim before or after expiry.",
    payAgain: "Pay again on PayPal",
