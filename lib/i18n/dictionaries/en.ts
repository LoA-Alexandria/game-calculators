...
const en = {
  ...
  guilds: {
    ...
    campsTitle: "Camps",
    campsHint: "Officers set which camp is ours, the order the others are hit in, and how many Rings and Horns to spend where.",
    campsTotals: "Planned for this siege: {rings} rings · {horns} horns",
    campOurs: "Our camp",
    ...
    campTarget: "Target {n}",
    campProgress: "Camp left",
    campProgressValue: "{percent} % left",
    campRings: "Rings",
    campHorns: "Horns",
    campRingsValue: "{count} rings",
    campHornsValue: "{count} horns",
    campNote: "Call",
    campNotePlaceholder: "Rings on the gate, horns after the wall drops…",
    campSave: "Save camp",
    campsHintMember: "Tap a camp to see the plan: the order they fall in, and the rings and horns the officers put on each one.",
