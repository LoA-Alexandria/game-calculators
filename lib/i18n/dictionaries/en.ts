...
const en = {
  ...
  guilds: {
    ...
    campsTitle: "Camps",
    campsHint: "Officers mark our camp and the order the others fall in, then point each member's rings, horns and attacks at a camp.",
    campsTotals: "Guild: rings {rings} · horns {horns}",
    campOurs: "Our camp",
    ...
    campSave: "Save camp",
    campsHintMember: "Write down the rings and horns you still have. Tap a camp to see its order and who is on it.",
    campsMapLabel: "Siege map",
    campsCentre: "Asgard",
    campsPick: "Tap a camp on the map.",
    campsOrderLabel: "Target order",
    campSpendShort: "R {rings} · H {horns}",
    campUnsetOurs: "Not ours",
    campOursHint: "No camp is marked as ours yet.",
