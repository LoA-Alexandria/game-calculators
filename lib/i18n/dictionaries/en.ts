...
const en = {
  ...
  theaterIncome: {
    ...
    intro: "Work out the Muse Coins a play earns with your theater upgrades and goddesses, compare the plays of each rarity, and see the Red Carpet points a performance drops. The fields start with Autumn’s test theater; replace them with your own.",
    ...
    compareLede: "Your income per play, best first within each rarity. Click a play to calculate it above. Autumn’s column is her own theater at {ticket} % ticket price, {visitors} % visitor flow, and {merchandise} merchandise.",
    colPlay: "Play",
    colBonus: "Bonus",
