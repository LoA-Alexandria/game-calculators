...
const en = {
  ...
  guilds: {
    ...
    hexBrushOurs: "Our colour",
    hexBrushAlly: "Ally colour",
    hexBrushClear: "Erase",
    hexBrushHint: "Tap a hex to paint. Settlements cycle neutral → ours → ally.",
    settlementNeutral: "{name}, neutral",
    settlementOurs: "{name}, ours",
    settlementAlly: "{name}, ally",
